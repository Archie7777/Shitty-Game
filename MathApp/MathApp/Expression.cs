...
namespace mathproblem
{
    class Expression
    {
        ...
        static public Expression.Difficulty GetDifficulty()
        {
            return difficulty;
        }
        static public Expression.IsPowerOp GetIsPowerOp()
        {
            return ipo;
        }
        static public Expression.PowerOpPrintType GetPrintType()
        {
            return powerOpPrintType;
        }
